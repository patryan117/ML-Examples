...
dataset['Fare'] = dataset['Fare'].fillna(train['Fare'].median()) # Fill in NA's in the "Fare" column with the median price (14.4542)
...
dataset['Title'] = dataset['Title'].replace('Mlle', 'Miss')      # replace the misspelled titles   ( correct title can be inferred by gender and table (e.g. Mlle and Mme both corespond to female gendered observations))
...
# print(train, "\n")  #TODO: double check that all columns are supposed to be intergers (0-4)
